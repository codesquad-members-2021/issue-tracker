...
insert into milestone(created_date_time, modified_date_time, description, due_date, title)
values (now(), now(), "M1 마일스톤에 대한 설명", "2021-06-21", "M1");
insert into milestone(created_date_time, modified_date_time, description, due_date, title)
values (now(), now(), "M2 마일스톤에 대한 설명", "2021-06-21", "M2");
insert into milestone(created_date_time, modified_date_time, description, due_date, title)
values (now(), now(), "M3 마일스톤에 대한 설명", "2021-06-21", "M3");
