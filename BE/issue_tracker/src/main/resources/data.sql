...
-- milestone
insert into milestone(id, content, created_date, due_date, `open`, title, deleted)
...
-- issue
insert into issue(id, created_time, `open`, title, writer_id, milestone_id, deleted)
values (1, CURRENT_TIMESTAMP, false, "이슈 제목1", 1, 1, false),
       (2, CURRENT_TIMESTAMP, true, "이슈 제목2", 2, 1, false);

-- label
insert into label(id, title, content, color, deleted)
...
-- comment
insert into comment(id, content, file, created_time, issue_id, writer_id, deleted)
values (1, "good", "file url", CURRENT_TIMESTAMP, 1, 1, false),
       (2, "nice", "file url", CURRENT_TIMESTAMP, 1, 2, true);

-- emoji
insert
into emoji(id, `name`, deleted)
