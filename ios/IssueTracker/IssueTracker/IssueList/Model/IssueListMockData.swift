...
struct IssueMock {
    static var firstData: Issue {
        .init(id: 1, number: 1, title: "[iOS] 이슈 목록 테이블 뷰 및 편집 기능", description: " 테이블뷰 코딩, 테이블뷰 배경 투명하게 만들기 ", isOpened: true, isHaveMyComment: false, timeStamp: "2021-06-09T13:35", writer: UserMock.lia, assignees: [UserMock.lia, UserMock.dumba], labels: [LabelMock.iOSLabel,LabelMock.FeatureLabel], milestone: MilestoneMock.iOSFirstData)
    }
    
    static var secondData: Issue {
        .init(id: 2, number: 2, title: "[iOS] 이슈목록 Model 및 Mock Data 생성", description: "이슈목록 Model 구조 설계 및 구현 ( Struct 예정 ) 그에 따른 Mock Data 및 외부 주입성 부여", isOpened: true, isHaveMyComment: true, timeStamp: "2021-06-09T14:14", writer: UserMock.dumba, assignees: [UserMock.lia, UserMock.dumba], labels: [LabelMock.iOSLabel,LabelMock.FeatureLabel], milestone: MilestoneMock.iOSFirstData)
    }
    
    static var thirdData: Issue {
        .init(id: 3, number: 3, title: "[FE] recoil 틀 만들기", description: "codesandbox에서 recoil을 만들어보았다", isOpened: true, isHaveMyComment: false, timeStamp: "2021-06-09T14:20", writer: UserMock.beemo, assignees: [UserMock.beemo], labels: [LabelMock.FELabel, LabelMock.FeatureLabel], milestone: MilestoneMock.feFirstData
        )
    }
}
